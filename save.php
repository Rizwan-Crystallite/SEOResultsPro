<?php
	...
	$html="<table><tr><td>Name</td><td>".$params['name']."</td></tr><tr><td>Email</td><td>".$params['email']."</td></tr><tr><td>Phone</td><td>	".$params['phone']."</td></tr><tr><td>message</td><td>".$params['comments']."</td></tr><tr><td>page URL</td><td>$pageURL</td></tr><tr><td>IP</td><td>$clientIP</td></tr><tr><td>Form Name</td><td>$hiddenform</td></tr></table>";
