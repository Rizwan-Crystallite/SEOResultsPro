<section class="NewBannerFy">
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-7">
                <div>
                    <h4 class="__font18 text-white">Reimagine Possibilities With</h4>
                    <h1 class="__font50 __fw700 text-white">Award Winning Website Optimization Services</h1>
                    <p class="__font16 __fw400 text-white">Discover the epitome of responsive web design prowess with SeoResultsPro's <br>premium services, ensuring your website flawlessly.
                    ...
                    <div class="pb-3 pt-4 mx-md-0 mx-3 homeBannerbtn">
                        ...
                        <a href="javascript:;" onclick="parent.LC_API.open_chat_window();return false;" rel="noopener noreferrer" class="ml-3 btn secondary-btn fw-700 senc">Live Chat</a>
            ...
            <div class="p-0 col-lg-4">
                <div class="contactform1">
                    <!-- Form -->
                    <form class="csforms" role="form">
                        <h4 class="__font16 __fw700 text-center text-white mb-4">MAKE AN OBLIGATION-FREE ENQUIRY</h4>
                        <div class="row mt-2">
                            <div class="form-group col-md-12">
                                <input type="text" id="name" name="name" placeholder="Type Full Name"
                            ...
                            <div class="form-group col-md-12">
                                <textarea type="textarea" id="comments" name="comments" placeholder="Message"
