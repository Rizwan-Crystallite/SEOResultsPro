        ...
        <div class="row justify-content-between">
            <div class="col-lg-7">
                <div>
                    ...
                    <h1 class="__font50 __fw700 text-white">Leading Website Design & Development Agency For The Best
                        Digital Experience</h1>
                    <p class="__font16 __fw400 text-white">Your website design should proudly represent your brand with
